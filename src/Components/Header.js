      ...
      <nav className="navbar" data-testid="header-container">
        ...
        <div className="top-nav bottomNav">
          <ul>
            ...
            <li className="top-nav-item"><NavLink className="nav_link" to="/">details</NavLink></li>
            <li className="top-nav-item"><NavLink className="nav_link" to="/">products</NavLink></li>
            <li className="top-nav-item"><NavLink className="nav_link" to="/">multi-products</NavLink></li>
            <li className="top-nav-item"><NavLink className="nav_link" to="/">new collections</NavLink></li>
            <li className="top-nav-item"><NavLink className="nav_link" to="/">old collection</NavLink></li>
            <li className="top-nav-item"><NavLink className="nav_link" to="/">low price </NavLink></li>
            <li className="top-nav-item"><NavLink className="nav_link" to="/">high price</NavLink></li>
          </ul>
        </div>
      </nav>
    </>
